...
export class create1653870326801 implements MigrationInterface {
    name = 'create1653870326801'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "status" character varying NOT NULL, "typeOfPayment" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "addressId" character varying, "buysId" uuid, CONSTRAINT "REL_73f9a47e41912876446d047d01" UNIQUE ("addressId"), CONSTRAINT "REL_cd4474a521276b2bbb35881e5e" UNIQUE ("buysId"), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
